...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('build/css/adminlte.css') }}"><!--end::Required Plugin(AdminLTE)--><!-- apexcharts -->
...
<script src="{{ asset('build/js/adminlte.js') }}"></script> <!--end::Required Plugin(AdminLTE)-->

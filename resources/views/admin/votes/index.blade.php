                    ...
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <ul class="pagination pagination-sm float-end">
                                <li class="page-item">
                                    <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-title="Select Election" data-bs-url="form_create/viewAllVotes" data-bs-size="">View All Votes</button> {{-- modal-lg --}}
                                </li>
                            </ul>
                        </div>
                    </div> <!-- /.card-header -->
